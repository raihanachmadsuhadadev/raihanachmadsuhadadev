...
I am a Fullstack Web Developer focused on building web applications, admin dashboards, REST APIs, and database-driven business systems.

I work with Laravel, Next.js, TypeScript, PostgreSQL, MySQL, MongoDB, Node.js, Express.js, and React. I also have experience in project documentation, requirement breakdown, system analysis, and basic IT/network operations.

Currently, I am improving my GitHub projects, technical documentation, deployment workflow, and fullstack development skills to grow as a professional software developer.
...
- Laravel and Next.js project structure
- REST API design
- Database design and optimization
- GitHub project documentation
- Deployment workflow
- Docker and Linux fundamentals
- DevOps and cybersecurity fundamentals

---

## Career Focus

I am currently focused on growing as a Fullstack Web Developer with additional strengths in system analysis, project documentation, and business web application development.
